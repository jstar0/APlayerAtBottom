    ...
    public static function header(){
		...
		$iapi = Typecho_Widget::widget('Widget_Options') -> Plugin('APlayerAtBottom') -> iapi;
      	...
      	if($aplayer === '0') {
			...
			echo '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/SatoSouta/APlayerAtBottom/staitc/APlayer.min.css">';
		}elseif($aplayer === '2'){}
    ...
    public static function footer(){
		...
		echo '<div id="downplayer"></div>';
      	...
      	if($aplayer === '0'){
        	...
        	echo '<script src="//cdn.jsdelivr.net/gh/SatoSouta/APlayerAtBottom/staitc/APlayer.min.js"></script>';
        }elseif($aplayer === '2'){}
